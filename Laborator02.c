...
void copiazaTelefoaneScumpe(struct Telefon* vector, char nrElemente, float pretMinim, 
...
struct Telefon getPrimulTelefonByProducator(struct Telefon* vector, int nrElemente, 
...
int main() {
	...
	telefoane[0] = initializare(1, 256, "Huawei", 4000, 'S');
	telefoane[1] = initializare(1, 350, "Apple", 6000, 'B');
	telefoane[2] = initializare(1, 300, "Samsung", 4500, 'A');
	...
	copiazaTelefoaneScumpe(telefoane, nrTelefoane, 5000, &telefoaneScumpe, &nrTelefoaneScumpe);
	printf("\n\nTelefoane scumpe:\n");
